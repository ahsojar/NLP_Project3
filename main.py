...
start_probs = hmm[2]
ner_tags = viterbi(['I', 'love', 'Gabriel', 'Gonzalez', 'and', 'he', 'lives', 'in', 'Ithaca', 'and', 'loves', 'Alisha', 'Sojar'], ['<S>','I-PER','B-PER', 'O', 'I-LOC','B-LOC', 'I-ORG', 'B-ORG', 'I-MISC','B-MISC'], start_probs, transition_probs, emission_probs)[1]
print ner_tags
